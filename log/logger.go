...
var levelStringMapping = map[int]string{
	...
	LOGGER_LEVEL_WARNING:   "W",
	LOGGER_LEVEL_NOTICE:    "N",
	LOGGER_LEVEL_INFO:      "I",
...
func (logger *Logger) Emergency(format string, a ...interface{}) {
	msg := fmt.Sprintf(format, a...)
	logger.Writer(LOGGER_LEVEL_EMERGENCY, msg)
}

//log alert format
func (logger *Logger) Alert(format string, a ...interface{}) {
	msg := fmt.Sprintf(format, a...)
	logger.Writer(LOGGER_LEVEL_ALERT, msg)
}

//log critical format
func (logger *Logger) Critical(format string, a ...interface{}) {
	msg := fmt.Sprintf(format, a...)
...
//log notice format
func (logger *Logger) Notice(format string, a ...interface{}) {
	msg := fmt.Sprintf(format, a...)
...
func Emergency(format string, a ...interface{}) {
	msg := fmt.Sprintf(format, a...)
	defaultLogger.Writer(LOGGER_LEVEL_EMERGENCY, msg)
}
func Alert(format string, a ...interface{}) {
	msg := fmt.Sprintf(format, a...)
	defaultLogger.Writer(LOGGER_LEVEL_ALERT, msg)
}
func Critical(format string, a ...interface{}) {
	msg := fmt.Sprintf(format, a...)
	defaultLogger.Writer(LOGGER_LEVEL_CRITICAL, msg)
}
func Error(format string, a ...interface{}) {
	msg := fmt.Sprintf(format, a...)
	defaultLogger.Writer(LOGGER_LEVEL_ERROR, msg)
}
func Warning(format string, a ...interface{}) {
	msg := fmt.Sprintf(format, a...)
	defaultLogger.Writer(LOGGER_LEVEL_WARNING, msg)
}
...
func Notice(format string, a ...interface{}) {
	msg := fmt.Sprintf(format, a...)
	defaultLogger.Writer(LOGGER_LEVEL_NOTICE, msg)
}
func Info(format string, a ...interface{}) {
	msg := fmt.Sprintf(format, a...)
	defaultLogger.Writer(LOGGER_LEVEL_INFO, msg)
}
func Debug(format string, a ...interface{}) {
	msg := fmt.Sprintf(format, a...)
	defaultLogger.Writer(LOGGER_LEVEL_DEBUG, msg)
}
